...
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('expired_subscription_report'); ?>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs nav-bordered mb-3">
                    <li class="nav-item">
                        <a href="<?= site_url('addons/bundle/subscription_report/active'); ?>" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="<?= site_url('addons/bundle/subscription_report/expire'); ?>" class="nav-link active">
                ...
                <div class="row justify-content-center">
                  <div class="col-xl-12">
                    <form class="form-inline justify-content-center" action="<?php echo site_url('addons/bundle/subscription_report/expire/filter') ?>" method="post">
                              ...
                              <?php
                               ...
                               <tr class="gradeU">
                                  ...
                                  <td>
                                    ...
                                    <p class="m-1"><?php echo get_phrase('expire_date').': <b class="text-danger">'.date('d M Y', $expire_date); ?></b></p>
                                  </td>
