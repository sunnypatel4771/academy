...
<div class="left-side-menu left-side-menu-detached">
	...
	<ul class="metismenu side-nav side-nav-light">
		...
		<?php if (has_permission('newsletter')) : ?>
			<li class="side-nav-item <?php if ($page_name == 'subscribed_user' || $page_name == 'newsletters') : ?> active <?php endif; ?>">
			...
			<li class="side-nav-item  <?php if ($page_name == 'system_settings' || $page_name == 'frontend_settings' || $page_name == 'payment_settings' || $page_name == 'manage_language' || $page_name == 'about' || $page_name == 'themes' || $page_name == 'custom_page' || $page_name == 'data_center' || $page_name == 'notification_settings') : ?> active <?php endif; ?>">
				...
				<ul class="side-nav-second-level" aria-expanded="false">
					...
					<?php if (addon_status('wasabi-s3')) : ?>
						<li class="<?php if ($page_name == 'wasabi_s3_settings') echo 'active'; ?>">
							<a href="<?php echo site_url('addons/wasabis3/settings'); ?>"><?php echo get_phrase('Wasabi S3 Settings'); ?></a>
						</li>
					<?php endif; ?>
